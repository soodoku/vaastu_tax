#!/usr/bin/env python3
"""Extract detail page URLs from collected Housing.com search HTML pages.
...
Example
-------
python scripts/housingcom/02_extract_urls.py --city hyderabad
python scripts/housingcom/02_extract_urls.py --all-cities
"""
...
def extract_urls_city(city: str, city_dir: Path) -> dict:
    ...
    for entry in successful_entries:
        ...
        base_url = entry.get("url", "https://housing.com")
