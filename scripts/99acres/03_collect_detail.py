#!/usr/bin/env python3
"""Collect 99acres property detail pages.
...
Example
-------
python scripts/99acres/03_collect_detail.py --city gurgaon --max-pages 500
python scripts/99acres/03_collect_detail.py --city gurgaon --resume
python scripts/99acres/03_collect_detail.py --city gurgaon --retry-errors
python scripts/99acres/03_collect_detail.py --all-cities --max-pages 100
"""
...
def collect_detail_city(
    ...
    with sync_playwright() as p:
        ...
        for idx, url_entry in enumerate(to_collect, start=1):
            ...
            property_type = url_entry.get("property_type", "")
            ...
            html_path = pages_detail / f"{slugify(city)}_{property_type}_{prop_id}.html.gz"
