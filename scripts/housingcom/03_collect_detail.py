#!/usr/bin/env python3
"""Collect Housing.com property detail pages.
...
Example
-------
python scripts/housingcom/03_collect_detail.py --city hyderabad --max-pages 500
python scripts/housingcom/03_collect_detail.py --city hyderabad --resume
python scripts/housingcom/03_collect_detail.py --city hyderabad --retry-errors
python scripts/housingcom/03_collect_detail.py --all-cities --max-pages 100
"""
...
def collect_detail_city(
    ...
    with sync_playwright() as p:
        ...
        for idx, url_entry in enumerate(to_collect, start=1):
            ...
            html, _, success = fetch_with_retry(page, url, wait_ms=1500)
